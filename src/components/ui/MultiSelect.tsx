...
export interface MultiSelectProps<T extends { label: string; value: string }>
  extends Omit<RootProps<T>, 'collection' | 'onValueChange' | 'value'> {
    ...
    >
      ...
      <Portal>
        <ChakraSelect.Positioner>
          <ChakraSelect.Content bg="surface" color="fg" borderColor="border" boxShadow="lg" zIndex="dropdown">
